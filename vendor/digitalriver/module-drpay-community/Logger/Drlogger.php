 ...
 * @phpstan-type Record array{message: string, context: mixed[], level: Level, level_name: LevelName, channel: string, extra: mixed[]}
 */
class Drlogger implements LoggerInterface, ResettableInterface
{
    /**
