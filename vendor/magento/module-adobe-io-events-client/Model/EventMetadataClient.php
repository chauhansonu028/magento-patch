...
class EventMetadataClient
{
    ...
    public function listRegisteredEventMetadata(EventProviderInterface $provider): array
    {
        ...
        $response = $this->requestExecutor->executeRequest(ApiRequestExecutor::GET, $uri, $configuration);
    ...
    public function deleteEventMetadata(
        ...
        $response = $this->requestExecutor->executeRequest(ApiRequestExecutor::DELETE, $uri, $configuration);
