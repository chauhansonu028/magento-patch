...
namespace Amasty\Blog\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_blog_should_load_css';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_Blog::css/source/mkcss/amblog.css');
        }
